...
echo '<ul class="breadcrumb">
    ...
    <li class="active">'.stripslashes($data['forum_name']).'</li>
</ul>';
...
//Le titre du forum
echo '<h3>'.stripslashes($data['forum_name']).'</h3><br /><br />';
$query->CloseCursor();
 
//Et le bouton pour poster
echo'<a href="./poster.php?action=nouveautopic&amp;f='.$forum.'" class="btn">Nouveau sujet</a>';
...
if ($query->rowCount()>0)
{
        ...
        <th class="titre"><span class="badge badge-important"><strong>Titre</strong></span></th>            
        <th class="nombremessages"><span class="badge badge-important"><strong>Réponses</strong></span></th>
        <th class="nombrevu"><span class="badge badge-important"><strong>Vus</strong></span></th>
        <th class="auteur"><span class="badge badge-important"><strong>Auteur</strong></span></th>                      
