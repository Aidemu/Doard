...
if (empty($_POST['pseudo'])) // Si on la variable est vide, on peut considérer qu'on est sur la page de formulaire
{
    ...
    <label for="avatar">Choisissez votre avatar :</label><input class="btn" type="file" name="avatar" id="avatar" />(Taille max : 1Mo)<br />
    ...
    <p><input type="submit" class="btn btn-primary" value="S\'inscrire" /></p></form>
    </div>
    </body>
    </html>';
...
}else //On est dans le cas traitement
{
    ...
    if (!empty($_FILES['avatar']['size']))
    {
        ...
        $maxsize = 1048576; //Poid de l'image
